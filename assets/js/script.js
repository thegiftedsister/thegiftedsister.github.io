...
$('#ue').click(function(){
	$('#ueW').show();
	$('.work').not('#ueW').css('display','none');
	$('.archiveListW').hide();
	$('#ue').css('border-bottom', '0.8px solid black');
	$('.under').not('#ue').css('border', 'none');
});
...
setInterval(function(){
	$("<span><img class='img'>The Portfolio for FFLAG HIGH</span>").appendTo("#fdsc");},100);
